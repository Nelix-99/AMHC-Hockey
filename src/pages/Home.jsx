...
export default function Home() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {/* Login prompt */}
      {!authed && (
        <div className="bg-white border-l-4 rounded-xl p-4 mb-5 flex items-center justify-between shadow-sm" style={{ borderColor: '#006847' }}>
          <div>
      ...
      {authed && (
        <div className="mt-6 flex gap-3 flex-wrap">
          <Link to="/lineup" className="btn-primary">
            Opstelling openen
          </Link>
